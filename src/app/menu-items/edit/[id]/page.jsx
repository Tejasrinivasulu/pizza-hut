...
const EditMenuItemPage = () => {
    ...
    async function handleFormSubmit(event, data) {
        ...
        const creationPromise = new Promise(async (resolve, reject) => {
            data = Object.assign(Object.assign({}, data), { _id: id });
    ...
    return (<section className='pt-10 pb-20 max-w-6xl mx-auto'>
      {profileData &&
          ...
          <div className="max-w-4xl mx-auto mt-12">
            {menuItem &&
                    <MenuItemForm buttonText={"Save Changes"} menuItem={menuItem} onSubmit={handleFormSubmit} onDelete={() => handleDeleteMenuItem()}/>}
          </div>
        </>}
    </section>);
};
